...
# Part 1
# input_prog = ['NOT A J', 'NOT B T', 'OR T J', 'NOT C T', 'OR J T', 'NOT D J', 'NOT J J', 'AND T J', 'RUN']

input_prog = ['NOT A J', 'OR B T', 'AND C T', 'NOT T T', 'AND D T', 'AND H T', 'OR T J', 'RUN']
# input_prog = ['NOT B J', 'WALK']

input_asscii = []

for line in input_prog:
    for char in line:
        input_asscii.append(ord(char))
    input_asscii.append(10)
...
while True:
    ...
    if icode == 1:
        ...
        input_val = input_asscii[index]
        print(f'Index {index} of {len(input_asscii) - 1} inputted')
        index += 1
...
# grid = [[]]
#
# for char in output_summary:
#     if char == 10:
#         grid.append([])
#     else:
#         grid[-1].append(chr(char))
#
# for line in grid:
#     print('')
#     for char in line:
...
print(f'The output is {output_summary[-1]}')